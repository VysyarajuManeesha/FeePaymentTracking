 ...
 <html>
<head>
<title>STUDENT_FEE DETAILS</title>
<style>
.btn {
  background:green;
...
<?php session_start();
	...
	echo "WELCOME ,<b> ".$user=$_SESSION['RegistrationNumber']."</b>";
...
if (!$select_db){
	...
	$user=$_SESSION['RegistrationNumber'];
...
<button><a href="Studentfeeenter.php">PAY</a></button>
</form>
</body>
</html>
