...
$query= "SELECT * FROM Registration where RegistrationNumber='$user'";
...
<form align="center" action="Adminfeeenter.php">
</br></br></br></br></br></br>
<button style="background-color:#123456;height:30px;width:50px;"><a style="text-decoration:none"><font color="white">PAY</font></a></button>
</form>
</body>
</html>
